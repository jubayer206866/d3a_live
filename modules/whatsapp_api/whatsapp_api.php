...
// Disabled - hook removed to prevent PDF generation error on invoice creation
...
hooks()->add_action('project_status_changed', 'wa_project_status_changed_hook');
function wa_project_status_changed_hook($data)
{
    $CI        = &get_instance();
    if (isset($data['project_id'])) {
        $CI->whatsapp_api_lib->send_mapped_template('project_status_changed', $data['project_id'], $data['status']);
    }
}
