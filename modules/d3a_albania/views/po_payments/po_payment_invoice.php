        ...
        <div class="panel_s">
          <div class="panel-body">
             <?php $csrf = array(
          	...
          	<h4 class="pull-left "><?php echo _l('payment_for').' '; ?><a href="<?php echo admin_url('d3a_albania/albania_po_invoice/'. $payment_invoice->pur_invoice); ?>"><?php echo pur_html_entity_decode($invoice->invoice_number); ?></a></h4>
				...
				<div class="row">
					...
					<table class="table table-borderd table-hover">
						<thead>
							...
							<tbody>
								<tr>
									<td><?php echo get_po_invoice_number($payment_invoice->pur_invoice); ?></td>
									...
									<?php if($invoice->payment_status != 'paid') { ?>
											<td class="text-danger">
												<?php echo app_format_money(po_invoice_left_to_pay($invoice->id), $base_currency->name); ?>
											</td>
										<?php } ?>
									</tr>
								</tbody>
...
<?php require 'modules/d3a_albania/assets/js/alb_invoice_preview.php';?>