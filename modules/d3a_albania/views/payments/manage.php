                ...
                <div class="col-md-12">
                    <div class="panel_s">
                        <div class="panel-body">
                            ...
                            <div class="tw-mb-3">
                                <a href="<?php echo admin_url('d3a_albania/payment'); ?>" class="btn btn-info"><?php echo _l('new'); ?></a>
                            </div>
                            <?php } ?>
...
<script>
    $(function () {
        initDataTable('.table-alb-payments', '<?php echo admin_url('d3a_albania/payments_table'); ?>', undefined, undefined, undefined, [0, 'desc']);
    });
</script>
</body>
