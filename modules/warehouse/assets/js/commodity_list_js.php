...
// Fix: Event delegation for dynamically loaded input fields
$(document).on('input', 'input[name="city"]', function() {
    table_commodity_list.DataTable().ajax.reload();
});

$(document).on('input', 'input[name="product_code"]', function() {
      table_commodity_list.DataTable().ajax.reload();
});
  ...
  function expenseSubmitHandler(form) {
    ...
    data.long_description = $('input[name="long_description"]').val();

    data.commodity_code = $('input[name="commodity_code"]').val();
    data.description = $('input[name="commodity_code"]').val();
    data.sku_code = $('input[name="commodity_code"]').val();
    data.sku_name = $('input[name="description"]').val();


    data.purchase_price = $('input[name="purchase_price"]').val();
    data.rate = $('input[name="rate"]').val();

    data.koli = $('input[name="koli"]').val();
    data.cope_koli = $('input[name="cope_koli"]').val();
    data.total_koli = $('input[name="total_koli"]').val();
    data.price_total = $('input[name="price_total"]').val();
    data.gross_weight = $('input[name="gross_weight"]').val();
    data.total_gross_weight = $('input[name="total_gross_weight"]').val();
    data.net_weight = $('input[name="net_weight"]').val();
    data.total_net_weight = $('input[name="total_net_weight"]').val();
    data.cbm_koli = $('input[name="cbm_koli"]').val();
    data.total_cbm = $('input[name="total_cbm"]').val();
  ...
  function edit_commodity_item(invoker) {
    ...
    $('#commodity_list-add-edit input[name="long_description"]').val($(invoker).data('long_description'));
    ...
    $('#commodity_list-add-edit input[name="koli"]').val($(invoker).data('koli'));
    $('#commodity_list-add-edit input[name="rate"]').val($(invoker).data('rate'));
    $('#commodity_list-add-edit input[name="cope_koli"]').val($(invoker).data('cope_koli'));
    $('#commodity_list-add-edit input[name="total_koli"]').val($(invoker).data('total_koli'));
    $('#commodity_list-add-edit input[name="price_total"]').val($(invoker).data('price_total'));

    $('#commodity_list-add-edit input[name="gross_weight"]').val($(invoker).data('gross_weight'));
    $('#commodity_list-add-edit input[name="total_gross_weight"]').val($(invoker).data('total_gross_weight'));
    $('#commodity_list-add-edit input[name="net_weight"]').val($(invoker).data('net_weight'));
    $('#commodity_list-add-edit input[name="total_net_weight"]').val($(invoker).data('total_net_weight'));
    $('#commodity_list-add-edit input[name="cbm_koli"]').val($(invoker).data('cbm_koli'));
    $('#commodity_list-add-edit input[name="total_cbm"]').val($(invoker).data('total_cbm'));
