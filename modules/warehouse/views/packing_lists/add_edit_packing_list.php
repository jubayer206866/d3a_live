			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<h4 class="no-margin font-bold "><i class="fa fa-inbox" aria-hidden="true"></i>
						...
						<input type="hidden" name="edit_approval"
							value="<?php echo new_html_entity_decode($edit_approval); ?>">
						<input type="hidden" name="save_and_send_request" value="false">
						<input type="hidden" name="main_additional_discount"
							value="<?php echo new_html_entity_decode($additional_discount); ?>">
						<input type="hidden" name="main_shipping_fee"
							value="<?php echo new_html_entity_decode($shipping_fee); ?>">
						<?php
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" name="packing_list_name" class="form-control"
											value="<?php echo new_html_entity_decode($packing_list_name); ?>">
									</div>
								</div>
					...
					<div class="panel-body mtop10 invoice-item">
						...
						<div class="table-responsive s_table ">
							<table
								...
								<thead>
									<tr>
										<th width="9%" align="left"><i class="fa fa-exclamation-circle"
												aria-hidden="true" data-toggle="tooltip"
												data-title="Product Code"></i>Code</th>
										<th width="7%" align="left">Name</th>
										<th width="7%" align="right">Cartons</th>
										<th width="7%" align="right" class="qty">Pieces/Carton</th>
										<th width="7%" align="right">Total/Pieces</th>
										<th width="7%" align="right">Price</th>
										<th width="7%" align="right">Price/Total</th>

										<th width="7%" align="right"><i class="fa fa-exclamation-circle"
												aria-hidden="true" data-toggle="tooltip" data-title="Net Weight"></i>N.W
										</th>
										<th width="7%" align="right"><i class="fa fa-exclamation-circle"
												aria-hidden="true" data-toggle="tooltip"
												data-title="Total Net Weight"></i>T.N.W</th>
										<th width="7%" align="right"><i class="fa fa-exclamation-circle"
												aria-hidden="true" data-toggle="tooltip"
												data-title="Gross Weight"></i>G.W</th>
										<th width="7%" align="right"><i class="fa fa-exclamation-circle"
												aria-hidden="true" data-toggle="tooltip"
												data-title="Total Gross Weight"></i>T.G.W</th>
										<th width="7%" align="right">CBM</th>
										<th width="7%" align="right">Total CBM</th>
						...
						<div class="col-md-12 mtop15">
							<div class="panel-body bottom-transaction">
								...
								<div class="btn-bottom-toolbar text-right">
									<a href="<?php echo admin_url('warehouse/manage_packing_list'); ?>"
									...
									<?php if (wh_check_approval_setting('5') != false) { ?>
										<?php if (isset($packing_list) && $packing_list->approval != 1) { ?>
											<a href="javascript:void(0)"
												class="btn btn-info pull-right mright5 add_packing_list_send"><?php echo _l('save_send_request'); ?></a>
									...
									<?php if (is_admin() || has_permission('wh_packing_list', '', 'edit') || has_permission('wh_packing_list', '', 'create')) { ?>
										<?php if (isset($packing_list) && $packing_list->approval == 0) { ?>
											<a href="javascript:void(0)"
												class="btn btn-info pull-right mright5 add_packing_list"><?php echo _l('save'); ?></a>
										<?php } elseif (!isset($packing_list)) { ?>
											<a href="javascript:void(0)"
												class="btn btn-info pull-right mright5 add_packing_list"><?php echo _l('save'); ?></a>
										<?php } ?>
