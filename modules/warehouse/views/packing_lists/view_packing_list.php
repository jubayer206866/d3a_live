				...
				<div class="horizontal-tabs">
					<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
						...
						<li role="presentation">
							<a href="#tab_activilog" class="tab_activilog" aria-controls="tab_activilog" role="tab"
								data-toggle="tab">
							...
							<div class="col-md-9 _buttons">
								...
								<div class="pull-right">
									<?php if ((has_permission('wh_packing_list', '', 'edit') || is_admin()) && ($packing_list->approval == 0)) { ?>
										<a href="<?php echo admin_url('warehouse/packing_list/' . $packing_list->id); ?>"
									...
									<div class="btn-group">
										<a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"><i class="fa fa-file-pdf"></i><?php if (is_mobile()) {
																															echo ' PDF';
																														} ?> <span class="caret"></span></a>
										<ul class="dropdown-menu dropdown-menu-right">
											<li class="hidden-xs"><a
													href="<?php echo admin_url('warehouse/packing_list_pdf/' . $packing_list->id . '?output_type=I'); ?>"><?php echo _l('view_pdf'); ?></a>
											</li>
											<li class="hidden-xs"><a
													href="<?php echo admin_url('warehouse/packing_list_pdf/' . $packing_list->id . '?output_type=I'); ?>"
													target="_blank"><?php echo _l('view_pdf_in_new_window'); ?></a></li>
											<li><a
													href="<?php echo admin_url('warehouse/packing_list_pdf/' . $packing_list->id); ?>"><?php echo _l('download'); ?></a>
											</li>
											<li>
												<a href="<?php echo admin_url('warehouse/packing_list_pdf/' . $packing_list->id . '?print=true'); ?>"
													target="_blank">
													<?php echo _l('print'); ?>
												</a>
											</li>
							...
							<div class="col-md-6">
								...
								<p class="no-mbot">
									<span class="bold">
										...
										<a
											href="<?php echo admin_url('warehouse/manage_delivery#' . $packing_list->delivery_note_id) ?>"><?php echo wh_get_delivery_code($packing_list->delivery_note_id); ?></a>
									</span>
								<h5 class="bold">
								</h5>
								</p>
									...
									<table class="table items items-preview estimate-items-preview"
										...
										<thead>
											<tr>
												...
												<th colspan="1" class="text-center"><?php echo _l('pieces_carton') ?>
												</th>
												...
												<th align="right" colspan="1"><?php echo _l('total_gross_weight') ?>
												</th>
										...
										<tbody class="ui-sortable">
											...
											$Total_cbm = 0;
											foreach ($packing_list_detail as $receipt_key => $receipt_value) {
												$receipt_key++;
											...
											?>
												...
												<tr data-toggle="tooltip"
													...
													<td class="text-right">
														<?php echo new_html_entity_decode($koli) ?>
													</td>
													<td class="text-right">
													...
													<td class="text-right">
														<?php echo clean_number($net_weight) ?>
													</td>
													<td class="text-right">
														<?php echo clean_number($total_net_weight)?>
													</td>
													<td class="text-right">
														<?php echo clean_number($gross_weight) ?>
													</td>
													<td class="text-right">
														<?php echo clean_number($total_gross_weight) ?>
													</td>
													<td class="text-right">
														<?php echo clean_number($cbm) ?>
													</td>
													<td class="text-right">
														...
														<div class="col-md-3 text-center">
															...
															?>
																...
																<?php if (file_exists(WAREHOUSE_STOCK_EXPORT_MODULE_UPLOAD_FOLDER . $packing_list->id . '/signature_' . $value['id'] . '.png')) { ?>
																	...
																	<img src="<?php echo site_url('modules/warehouse/uploads/stock_export/' . $packing_list->id . '/signature_' . $value['id'] . '.png'); ?>"
									...
									if ($packing_list->approval != 1 && ($check_approve_status == false)) { ?>
										<?php if ($check_appr && $check_appr != false) { ?>
											<a data-toggle="tooltip"
												class="btn btn-success lead-top-btn lead-view send_request_approve_class"
												data-placement="top" href="#"
												onclick="send_request_approve(<?php echo new_html_entity_decode($packing_list->id); ?>); return false;"><?php echo _l('send_request_approve'); ?></a>
										<?php } ?>
												...
												<ul class="dropdown-menu dropdown-menu-right menu-width-height">
													...
													<li>
														<div class="row text-right col-md-12">
															<a href="#"
																onclick="approve_request(<?php echo new_html_entity_decode($packing_list->id); ?>); return false;"
																class="btn btn-success button-margin approve_request_class"><?php echo _l('approve'); ?></a>
															<a href="#" data-loading-text="<?php echo _l('wait_text'); ?>"
																onclick="deny_request(<?php echo new_html_entity_decode($packing_list->id); ?>); return false;"
									...
									<div class="date">
										...
										<?php if ($log['staffid'] == get_staff_user_id() || is_admin() || has_permission('wh_packing_list', '', 'delete()')) { ?>
											<a href="#" class="pull-right text-danger"
												onclick="delete_wh_activitylog(this,<?php echo new_html_entity_decode($log['id']); ?>);return false;"><i
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<input type="text" class="sig-input-style" tabindex="-1" name="signature"
								id="signatureInput">
						...
						<div class="modal-footer">
							...
							<button onclick="sign_request(<?php echo new_html_entity_decode($packing_list->id); ?>);"
								autocomplete="off"
