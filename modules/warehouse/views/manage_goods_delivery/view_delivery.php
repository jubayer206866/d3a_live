              ...
              <tbody>
                ...
                <tr class="project-overview">
                 ...
                 <th align="right" colspan="1"><?php echo _l('total_cbm') ?></th>
                             ...
                             $koli = (isset($delivery_value) ? $delivery_value['koli'] : '');
                             $cope_koli = (isset($delivery_value) ? $delivery_value['cope_koli'] : '');
                             $total_koli = (isset($delivery_value) ? _d($delivery_value['total_koli']) : '');
                             $price = (isset($delivery_value) ? $delivery_value['price'] : '');
                             $price_total = (isset($delivery_value) ? $delivery_value['price_total'] : '');
                             $price_total = (strpos($price_total, '¥') !== false) ? $price_total: '¥' . $price_total;
                             $net_weight = (isset($delivery_value) ? $delivery_value['net_weight'] : '');
                             $total_net_weight = (isset($delivery_value) ? $delivery_value['total_net_weight'] : '');
                             $gross_weight = (isset($delivery_value) ? $delivery_value['gross_weight'] : '');
                             $total_gross_weight = (isset($delivery_value) ? $delivery_value['total_gross_weight'] : '');
                             $cbm = (isset($delivery_value) ? $delivery_value['cbm_koli'] : '');
                             $total_cbm = (isset($delivery_value) ? $delivery_value['total_cbm'] : '');
                             $commodity_name = (isset($delivery_value) ? $delivery_value['commodity_long_description'] : '');
                             $commodity_code = (isset($delivery_value) ? $delivery_value['commodity_name'] : '');
                              if($koli !='0' && $koli != null) { 
                             $cartons += (float) $koli;
                          ...
                          <?php if($koli !='0' && $koli != null) { ?>
                            <tr>
                              <td ><?php echo new_html_entity_decode($delivery) ?></td>
                                  ...
                                  <td ><?php echo ($commodity_name) ?></td>
                                  <td ><?php echo new_html_entity_decode($koli) ?></td>
                                  <td ><?php echo new_html_entity_decode($cope_koli) ?></td>
                                  <td class="text-right"><?php echo new_html_entity_decode($total_koli) ?></td>
                                  <td class="text-right"><?php echo ((float)$price) ?></td>
                                  <td class="text-right"><?php echo ($price_total) ?></td>
                                  <td class="text-right"><?php echo clean_number($gross_weight) ?></td>
                                  <td class="text-right"><?php echo clean_number($total_gross_weight) ?></td>
                                   <td class="text-right"><?php echo clean_number((float)$net_weight) ?></td>
                                  <td class="text-right"><?php echo clean_number((float)$total_net_weight) ?></td>
                                  <td class="text-right"><?php echo clean_number($cbm) ?></td>
                                  <td class="text-right"><?php echo clean_number($total_cbm) ?></td>
                                </tr>
                         <?php } ?>
                             <?php  } ?>
                              </tbody>
