      ...
      <div class="col-md-12" id="small-table">
        <div class="panel_s">
          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <h4 class="no-margin font-bold "><i class="fa fa-object-ungroup menu-icon" aria-hidden="true"></i>
            ...
            <input type="hidden" name="additional_discount"
              value="<?php echo new_html_entity_decode($additional_discount); ?>">
              ...
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <?php echo render_date_input('date_add', 'Container Loadling Date', _d($date_add), $disabled) ?>
                  </div>
                  ...
                  <div
                    ...
                    <div class="form-group">
                      ...
                      <select onchange="pr_order_change(this); return false;" name="pr_order_id" id="pr_order_id"
                        class="selectpicker" data-live-search="true" data-width="100%"
                        data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" <?php if ($edit_approval == 'true') {
                             echo 'disabled';
                           }
                           ; ?>>
                        <option value=""></option>
                        <?php foreach ($pr_orders as $pr_order) { ?>
                          <option value="<?php echo new_html_entity_decode($pr_order['pr_order_id']); ?>" <?php if (isset($goods_delivery) && ($goods_delivery->pr_order_id == $pr_order['pr_order_id'])) {
                               echo 'selected';
                             } ?>>
                            <?php echo ($pr_order['goods_receipt_code'] . ' - ' . $pr_order['supplier_name']); ?>
                          </option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <div
                    class="col-md-6 <?php if ($pr_orders_status == true && get_warehouse_option('goods_delivery_required_po') == 1) {
                      echo 'hide';
                    }
                    ; ?> ">
                    <div class="form-group">
                      <label for="invoice_id"><?php echo _l('invoices'); ?></label>
                      <select onchange="invoice_change(this); return false;" name="invoice_id" id="invoice_id"
                        class="selectpicker" data-live-search="true" data-width="100%"
                        data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" <?php if ($edit_approval == 'true') {
                             echo 'disabled';
                           }
                        ...
                        <?php foreach ($invoices as $invoice) { ?>
                          <option value="<?php echo new_html_entity_decode($invoice['id']); ?>" <?php if (isset($goods_delivery) && $goods_delivery->invoice_id == $invoice['id']) {
                               echo 'selected';
                             } ?>>
                            <?php echo format_invoice_number($invoice['id']) . ' - ' . $invoice['company'] . ' - ' . $invoice['name']; ?>
                          </option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <select name="customer_code" id="vendor" class="selectpicker" data-live-search="true"
                        ...
                        <?php foreach ($customer_code as $s) { ?>
                          <option value="<?php echo new_html_entity_decode($s['userid']); ?>" <?php if (isset($goods_delivery) && $goods_delivery->customer_code == $s['userid']) {
                               echo 'selected';
                             } ?>><?php echo new_html_entity_decode($s['company']); ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  ...
                  <?php if (ACTIVE_PROPOSAL == true) { ?>
                    ...
                    ; ?>">
                      ...
                      <select name="project" id="project" class="selectpicker" data-live-search="true" data-width="100%"
                        data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                        <option value=""></option>

                        <?php if (isset($projects)) { ?>
                          <?php foreach ($projects as $s) { ?>
                            <option value="<?php echo new_html_entity_decode($s['id']); ?>" <?php if (isset($goods_delivery) && $s['id'] == $goods_delivery->project) {
                                 echo 'selected';
                               } ?>>
                    ...
                    ; ?>">
                      ...
                      <select name="type" id="type" class="selectpicker" data-live-search="true" data-width="100%"
                        data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                        <option value=""></option>
                      ...
                      <select name="department" id="department" class="selectpicker" data-live-search="true"
                        ...
                        <?php if (isset($departments)) { ?>
                          <?php foreach ($departments as $s) { ?>
                            <option value="<?php echo new_html_entity_decode($s['departmentid']); ?>" <?php if (isset($goods_delivery) && $s['departmentid'] == $goods_delivery->department) {
                                 echo 'selected';
                               } ?>><?php echo new_html_entity_decode($s['name']); ?></option>
                          <?php } ?>
                      ...
                      <select name="requester" id="requester" class="selectpicker" data-live-search="true"
                        ...
                        <?php if (isset($staffs)) { ?>
                          ...
                          <?php foreach ($staffs as $s) { ?>
                            <option value="<?php echo new_html_entity_decode($s['staffid']); ?>" <?php if (isset($goods_delivery) && $s['staffid'] == $goods_delivery->requester) {
                                 echo 'selected';
                               } ?>>
                              <?php echo new_html_entity_decode($s['lastname'] . ' ' . $s['firstname']); ?></option>
                          <?php } ?>
                  ...
                  <div class="col-md-3 hide">
                    <a href="#" class="pull-right display-block input_method"><i
                        ...
                        data-original-title="<?php echo _l('goods_delivery_warehouse_tooltip'); ?>"></i></a>
                    ...
                    <div class="form-group">
                      ...
                      <select name="warehouse_id" id="warehouse_id" class="selectpicker" data-live-search="true"
                        ...
                        <?php foreach ($warehouses as $wh_value) { ?>
                          <option value="<?php echo new_html_entity_decode($wh_value['warehouse_id']); ?>" <?php if (isset($goods_delivery) && $goods_delivery->warehouse_id == $wh_value['warehouse_id']) {
                               echo 'selected';
                  ...
                  <div class=" col-md-6">
                    <div class="form-group">
                      ...
                      <select name="staff_id" class="selectpicker" id="staff_id" data-width="100%"
                        data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" <?php if ($edit_approval == 'true') {
                             echo 'disabled';
                           }
                           ; ?>>
                        <option value=""></option>
                        <?php foreach ($staff as $s) { ?>
                          <option value="<?php echo new_html_entity_decode($s['staffid']); ?>" <?php if (isset($goods_delivery) && $goods_delivery->staff_id == $s['staffid']) {
                               echo 'selected';
                             } ?>>
                            <?php echo new_html_entity_decode($s['firstname']) . '' . new_html_entity_decode($s['lastname']); ?>
                          </option>
                        <?php } ?>
                      </select>
          ...
          <div class="panel-body mtop10 invoice-item">
            ...
            <div class="table-responsive s_table ">
              <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                <thead>
                  <tr>
                  <th width="9%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true"
                            data-toggle="tooltip" data-title="Product Code"></i><?php echo _l('product_code'); ?></th>
                        <th width="7%" align="left"><?php echo _l('product_name'); ?></th>
                        <th width="7%" align="right"><?php echo _l('cartons'); ?></th>
                        <th width="7%" align="right" class="qty"><?php echo _l('pieces_carton'); ?></th>
                        <th width="7%" align="right"><?php echo _l('total_pieces'); ?></th>
                        <th width="7%" align="right"><?php echo _l('price'); ?></th>
                        <th width="7%" align="right"><?php echo _l('price_total'); ?></th>
                        <th width="7%" align="right"><i class="fa fa-exclamation-circle" aria-hidden="true"
                            data-toggle="tooltip" data-title="<?php echo _l('gross_weight'); ?>"></i>G.W</th>
                        <th width="7%" align="right"><i class="fa fa-exclamation-circle" aria-hidden="true"
                            data-toggle="tooltip" data-title="<?php echo _l('total_gross_weight'); ?>"></i>T.G.W</th>
                        <th width="7%" align="right"><i class="fa fa-exclamation-circle" aria-hidden="true"
                            data-toggle="tooltip" data-title="<?php echo _l('net_weight'); ?>"></i>N.W</th>
                        <th width="7%" align="right"><i class="fa fa-exclamation-circle" aria-hidden="true"
                            data-toggle="tooltip" data-title="<?php echo _l('total_net_weight'); ?>"></i>T.N.W</th>
                        <th width="7%" align="right"><?php echo _l('cbm'); ?></th>
                        <th width="7%" align="right"><?php echo _l('total_cbm'); ?></th>
            ...
            <div class="col-md-8 col-md-offset-4">
              <table class="table text-right hidden">
                <tbody>
                  <tr id="subtotal">
                  ...
                  <tr id="wh_shipping_fee" class="<?php if (get_option('wh_hide_shipping_fee') == 1) {
                    echo "hide";
                  } ?>">
            ...
            <div class="col-md-12 mtop15">
              <div class="panel-body bottom-transaction">
                ...
                <div class="btn-bottom-toolbar text-right">
                  <a href="<?php echo admin_url('warehouse/manage_delivery'); ?>"
                  ...
                  <?php if (wh_check_approval_setting('2') != false) { ?>
                    <?php if (isset($goods_delivery) && $goods_delivery->approval != 1) { ?>
                      <a href="javascript:void(0)"
                        class="btn btn-info pull-right mright5 add_goods_delivery_send"><?php echo _l('save_send_request'); ?></a>
                  ...
                  <?php if (is_admin() || has_permission('wh_stock_export', '', 'edit') || has_permission('wh_stock_export', '', 'create')) { ?>
                    <?php if (isset($goods_delivery) && $goods_delivery->approval == 0) { ?>
                      <a href="javascript:void(0)"
                        class="btn btn-info pull-right mright5 add_goods_delivery"><?php echo _l('save'); ?></a>
                    <?php } elseif (!isset($goods_delivery)) { ?>
                      <a href="javascript:void(0)"
                        class="btn btn-info pull-right mright5 add_goods_delivery"><?php echo _l('save'); ?></a>
