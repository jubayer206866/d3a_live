						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane ptop10 active" id="tab_pur_invoice">
								<div class="col-md-6 pad_left_0">
									...
									<div class="col-md-6 pad_right_0">
										<p>
											<?php echo _l('delivery_receive') . ':'; ?>
											<span class="pull-right bold">
												<?php
												$goods_receipt_id = $pur_invoice->goods_receipt_id;
												$goods_receipt_code = '';
												...
												if ($goods_receipt_id) {
													...
													if ($goods_receipt) {
														$goods_receipt_code = $goods_receipt->goods_receipt_code;
													}
												}

												if ($goods_receipt_code != '') {
													echo pur_html_entity_decode($goods_receipt_code);
												} else {
													echo '-';
												}
												?>
								...
								<div class="col-md-12 pad_left_0 pad_right_0">
									<div class="table-responsive">
										<table class="table items items-preview estimate-items-preview" data-type="estimate">
											<thead>
												<tr>
													<th class="description" align="left"><?php echo _l('product_code'); ?></th>
													<th align="right"><?php echo _l('product_name'); ?></th>
													<th align="right"><?php echo _l('cartons'); ?></th>
													<th align="right"><?php echo _l('Pieces/Carton'); ?></th>
													<th align="right"><?php echo _l('Total/Pieces'); ?></th>
													<th align="right"><?php echo _l('Price'); ?></th>
													<th align="right"><?php echo _l('price_total'); ?></th>
													<th align="right"><?php echo _l('G.W'); ?></th>
													<th align="right"><?php echo _l('T.G.W'); ?></th>
													<th align="right"><?php echo _l('N.W'); ?></th>
													<th align="right"><?php echo _l('T.N.W'); ?></th>
													<th align="right"><?php echo _l('CBM'); ?></th>
													<th align="right"><?php echo _l('Total Cbm'); ?></th>
												</tr>
											</thead>
											...
											<tbody class="ui-sortable">
												...
												?>
														<tr nobr="true" class="sortable">
															<td align="right"><?php echo pur_html_entity_decode($es['item_name']); ?></td>
															<td align="right"><?php echo pur_html_entity_decode($es['description']); ?></td>
															<td align="right"><?php echo pur_html_entity_decode($es['koli']); ?></td>
															<td align="right"><?php echo pur_html_entity_decode($es['cope_koli']); ?></td>
															<td align="right"><?php echo pur_html_entity_decode($es['total_koli']); ?></td>
															<td align="right"><?php echo pur_html_entity_decode($es['price']); ?></td>
															<td align="right"><?php echo app_format_money($es['price_total'], $base_currency->symbol); ?></td>
															<td align="right"><?php echo clean_number($es['gross_weight']); ?></td>
															<td align="right"><?php echo clean_number($es['total_gross_weight']); ?></td>
															<td align="right"><?php echo clean_number($es['net_weight']); ?></td>
															<td align="right"><?php echo clean_number($es['total_net_weight']); ?></td>
															<td align="right"><?php echo clean_number($es['cbm_koli']); ?></td>
															<td align="right"><?php echo clean_number($es['total_cbm']); ?></td>
														</tr>
												<?php
														$sum_cartons += (float)$es['koli'];
														$sum_total_prices += (float)$es['total_koli'];
														$sum_price_total += (float) preg_replace('/[^0-9.]/', '', $es['price_total']);
														$sum_total_gross_weight += (float)$es['total_gross_weight'];
														$sum_total_net_weight += (float)$es['total_net_weight'];
														$sum_total_cbm += (float)$es['total_cbm'];
