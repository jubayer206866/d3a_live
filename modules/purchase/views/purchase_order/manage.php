	              	...
	              	<div class="row">
                       ...
                       <div class="col-md-3 form-group">
                         ...
                         <select name="delivery_status[]" id="delivery_status" class="selectpicker" multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('leads_all'); ?>">
                           <option value="0" ><?php echo _l('waiting_to_receive'); ?></option>
                           <option value="1" ><?php echo _l('received'); ?></option>
                        </select>
                       </div>
                       <div class="col-md-3">
	                        <?php echo render_date_input('from_due_date',_l('from_due_date'),''); ?>
	                    </div>
	                    <div class="col-md-3">
	                        <?php echo render_date_input('to_due_date',_l('to_due_date'),''); ?>
	                    </div>
                       <div class="col-md-3 form-group">
                           <label for="clientid"><?php echo _l('client'); ?></label>
                           <select name="clientid[]" id="clientid" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('leads_all'); ?>">
                              <?php foreach($customers as $c){ ?>
                                    <option value="<?php echo pur_html_entity_decode($c['userid']); ?>">
                                       <?php echo pur_html_entity_decode($c['company']); ?>
                                    </option>
                              <?php } ?>
                           </select>
                        </div>
