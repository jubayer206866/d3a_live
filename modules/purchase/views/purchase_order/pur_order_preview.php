            ...
            <div class="col-md-8">
               <div class="btn-group pull-right">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                     ...
                     <li>
                        <a href="<?php echo admin_url('purchase/print_qrcode/'.$estimate->id); ?>" target="_blank">
                        <?php echo _l('shipping_mark'); ?>
                        </a>
                     </li>
                     <li>
                        <a href="<?php echo admin_url('warehouse/po_item_print/'.$estimate->id); ?>" target="_blank">
                        <?php echo _l('barcode'); ?>
                        </a>
                     </li>
                           ...
                           <table class="table items items-preview estimate-items-preview" data-type="estimate">
                              <thead>
                                 <tr>
                                    ...
                                    <th align="right"><?php echo _l('product_name'); ?></th>
                                    <th align="right"><?php echo _l('cartons'); ?></th>
                                    <th align="right"><?php echo _l('pieces_carton'); ?></th>
                                    <th align="right"><?php echo _l('total_pieces'); ?></th>
                                    <th align="right"><?php echo _l('price'); ?></th>
                                    <th align="right"><?php echo _l('price_total'); ?></th>
                        ...
                        <th width="7%" align="right"><?php echo _l('total_cbm'); ?></th>
                              ...
                              <tbody class="ui-sortable">
                                 ...
                                 <tr nobr="true" class="sortable">
                                    ...
                                    ?></strong></span></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['description']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['koli']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['cope_koli']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['total_koli']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['price']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['price_total']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['gross_weight']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['total_gross_weight']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['net_weight']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['total_net_weight']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['cbm_koli']); ?></td>
                                    <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['total_cbm']); ?></td>
                                    
                                 </tr>
                                 <?php 
   $t_mn += (float) $es['total_money'];
   $item_discount += (float) $es['discount_money'];
   $cartons += (float) preg_replace('/[^0-9.]/', '', (string) ($es['koli'] ?? ''));
   $totalPieces += (float) preg_replace('/[^0-9.]/', '', (string) ($es['total_koli'] ?? ''));
   $raw_price_total = isset($es['price_total']) ? trim((string) $es['price_total']) : '';
   if ($raw_price_total === '') {
      $Pricetotal += (float) ($es['total_money'] ?? 0);
   } else {
      $Pricetotal += (float) preg_replace('/[^0-9.]/', '', $raw_price_total);
   }
   $Total_net_weight += (float) preg_replace('/[^0-9.]/', '', (string) ($es['total_net_weight'] ?? ''));
   $Total_gross_weight += (float) preg_replace('/[^0-9.]/', '', (string) ($es['total_gross_weight'] ?? ''));
   $Total_cbm += (float) preg_replace('/[^0-9.]/', '', (string) ($es['total_cbm'] ?? ''));
   $count++;
   }
   }
?> 
                              ...
                              <tr id="price_total">
                                 <td><span class="bold"><?php echo _l('price_total'); ?></span>
                                   ...
                                   <td class="price_total">
                                       <?php echo app_format_money($Pricetotal, ''. '¥'); ?>
                                    </td>
                              </tr>
