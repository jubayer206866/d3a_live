                 ...
                 <div class="modal bulk_actions" id="table_vendors_list_bulk_actions" tabindex="-1" role="dialog">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <label for="city"><?php echo _l('report_vendor_city'); ?></label>
                        <input type="text" id="city" class="form-control" placeholder="Enter city" name="city">
                      </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                         <label for="category"><?php echo _l('report_vendor_category'); ?></label>
                     ...
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="vendors"><label></label></div>',
                       array(
                        ...
                        array(
                           'name'=>_l('store_number'),
                           'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-number')
                          ),
                          array(
                           'name'=>_l('vendor_type'),
                           'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-type')
                          ),
                        array(
