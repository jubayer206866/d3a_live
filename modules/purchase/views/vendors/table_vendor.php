...
$aColumns = [
    ...
    db_prefix().'pur_vendor.store_number as store_number',
    db_prefix().'pur_vendor.vendor_type as vendor_type',
    db_prefix().'pur_vendor.city as vendor_city',
];
...
foreach ($rResult as $aRow) {
    ...
    $row[] = ($aRow['vendor_city'] ? '<a href="tel:' . $aRow['vendor_city'] . '">' . $aRow['vendor_city'] . '</a>' : '');
    $row[] = ($aRow['store_number'] ? '<a href="tel:' . $aRow['store_number'] . '">' . $aRow['store_number'] . '</a>' : '');
    $row[] = ($aRow['vendor_type'] ? '<a href="tel:' . $aRow['vendor_type'] . '">' . $aRow['vendor_type'] . '</a>' : '');
