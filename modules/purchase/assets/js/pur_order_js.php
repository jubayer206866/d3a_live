...
function pur_add_item_to_preview(id) {
  ...
  requestGetJSON('purchase/get_item_by_id/' + id+'/'+ currency_rate ).done(function (response) {
    ...
    $('.main input[name="koli"]').val(response.koli);
    $('.main input[name="cope_koli"]').val(response.cope_koli);
    $('.main input[name="total_koli"]').val(response.total_koli);
    $('.main input[name="price_total"]').val(response.price_total);
    $('.main input[name="gross_weight"]').val(response.gross_weight);
    $('.main input[name="total_gross_weight"]').val(response.total_gross_weight);
    $('.main input[name="net_weight"]').val(response.net_weight);
    $('.main input[name="total_net_weight"]').val(response.total_net_weight);
    $('.main input[name="cbm_koli"]').val(response.cbm_koli);
    $('.main input[name="total_cbm"]').val(response.total_cbm);
    $('.main input[name="price"]').val(response.rate);
...
function pur_add_item_to_table(data, itemid) {
  ...
  var koli = $('input[name="koli"]').val();
  var cope_koli = $('input[name="cope_koli"]').val();
  var total_koli = $('input[name="total_koli"]').val();
  var price = $('input[name="price"]').val();
  var price_total = $('input[name="price_total"]').val();
  var gross_weight = $('input[name="gross_weight"]').val();
  var total_gross_weight = $('input[name="total_gross_weight"]').val();
  var net_weight = $('input[name="net_weight"]').val();
  var total_net_weight = $('input[name="total_net_weight"]').val();
  var cbm_koli = $('input[name="cbm_koli"]').val();
  var total_cbm = $('input[name="total_cbm"]').val();

  var table_row = '';
  var item_key = lastAddedItemKey ? lastAddedItemKey += 1 : $("body").find('.invoice-items-table tbody .item').length + 1;
  lastAddedItemKey = item_key;
  $("body").append('<div class="dt-loader"></div>');
  pur_get_item_row_template('newitems[' + item_key + ']',data.item_name, data.description, data.quantity, data.unit_name, data.unit_price, data.taxname, data.item_code, data.unit_id, data.tax_rate, data.discount, itemid, currency_rate, to_currency,koli,cope_koli,total_koli,price,price_total,gross_weight,total_gross_weight,net_weight,total_net_weight,cbm_koli,total_cbm).done(function(output){
    table_row += output;
...
function pur_get_item_row_template(name, item_name, description, quantity, unit_name, unit_price, taxname,  item_code, unit_id, tax_rate, discount, item_key, currency_rate, to_currency,koli,cope_koli,total_koli,price,price_total,gross_weight,total_gross_weight,net_weight,total_net_weight,cbm_koli,total_cbm)  {
  "use strict";
  jQuery.ajaxSetup({
    async: false
  });
