...
"use strict"; 
    ...
    var Params = {
        ...
        "from_due_date" : 'input[name="from_due_date"]',
        "to_due_date" : 'input[name="to_due_date"]',
	...
	// Wait for table to be initialized, then attach event handlers
	setTimeout(function() {
    ...
    $.each(Params, function(i, obj) {
        $('select' + obj).on('change', function() {
            ...
            table_rec_campaign.DataTable().ajax.reload(function() {
                $(this).val(selectedVals);
    ...
    $('input[name="from_due_date"]').on('change', function() {
        table_rec_campaign.DataTable().ajax.reload()
                .columns.adjust()
                .responsive.recalc();
    });
    $('input[name="to_due_date"]').on('change', function() {
        table_rec_campaign.DataTable().ajax.reload()
                .columns.adjust()
                .responsive.recalc();
    });
