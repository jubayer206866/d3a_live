...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('statement', [
        'name'     => _l('Statements'),
        'href'     => admin_url('statement_report'),
    ...
    if (staff_can('view', 'contracts') || staff_can('view_own', 'contracts')) {
        ...
        $CI->app_menu->add_sidebar_children_item('contracts', [
            'slug' => 'lcl_contract',
            'name' => _l('lcl_contract'),
            'href' => admin_url('contracts/lcl_contract'),
            'position' => 1,
            'badge' => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('contracts', [
            'slug' => 'ddp_contract',
            'name' => _l('ddp_contract'),
            'href' => admin_url('contracts/ddp_contract'),
            'position' => 2,
            'badge' => [],
        ]);
        $CI->app_menu->add_sidebar_children_item('contracts', [
            'slug' => 'landing_contract',
            'name' => _l('landing_contract'),
            'href' => admin_url('contracts/landing_contract'),
            'position' => 3,
            'badge' => [],
        ]);
    }
    ...
    //calculator
    $CI->app_menu->add_sidebar_menu_item('calculator', [
        'collapse' => true,
        'name' => _l('calculator'),
        'position' => 55,
    ...
    $CI->app_menu->add_sidebar_children_item('calculator', [
        'slug' => 'lcl_calculator',
        'name' => _l('lcl_calculator'),
        'href' => admin_url('calculator/lcl'),
        'position' => 5,
        'badge' => [],
    ]);
    ...
    $CI->app_menu->add_sidebar_children_item('calculator', [
        'slug' => 'dpp_calculator',
        'name' => _l('dpp_calculator'),
        'href' => admin_url('calculator/dpp'),
        'position' => 5,
        'badge' => [],
    ]);
    ...
    if (is_admin()) {
        ...
        //Add By Rifat......
        $CI->app_menu->add_setup_menu_item('shipping_company', [
            'name' => _l('shipping_company'),
            'href' => admin_url('Settings/shipping_company'),
            'position' => 5,
            'badge' => [],
        ]);
        $CI->app_menu->add_setup_menu_item('calculator', [
            'collapse' => true,
            'name'     => _l('calculator'), 
            'position' => 6,
            'badge'    => [],
        ...
        $CI->app_menu->add_setup_children_item('calculator', [
             'slug' => 'materials-list',
             'name' => _l('materials'),
             'href' => admin_url('calculators/materials'),
            'position' => 5,
            'badge'    => [],
        ]);
        ...
        $CI->app_menu->add_setup_children_item('calculator', [
            ...
            'name'     => _l('calculator_categories'),
            'href' => admin_url('calculators/categories'),
            'position' => 10,
            'badge'    => [],
        ]);

        $CI->app_menu->add_setup_children_item('calculator', [
            'slug'     => 'calculator-ladder-rates',
            'name'     => _l('ladder_rates'),
            'href'     => admin_url('calculators/ladder_rates'),
            'position' => 15,
            'badge'    => [],
        ]);
