...
$_table_data                         = [
    ...
    [
        'name'     => _l('shipping_mark'),
        'th_attrs' => ['class' => 'toggleable', 'id' => 'th-shipping-mark'],
    ],
    [
        'name'     => _l('tier'),
        'th_attrs' => ['class' => 'toggleable', 'id' => 'th-tier'],
    ],[
        'name'     => _l('service_fee'),
        'th_attrs' => ['class' => 'toggleable', 'id' => 'th-service-fee'],
    ],
    [
    ...
    [
        ...
        'th_attrs' => ['class' => 'text-center ', 'id' => 'th-admins'],
    ],
    [
...
<script>
        ...
        var fnServerParams = {
            "shipping_mark_filter[]": '[name="filter_shipping_mark[]"]',
            "tier_filter[]": '[name="filter_tier[]"]'
        };

        var tAPI = initDataTable(
            '.table-clients',
        ...
        $('select[name="filter_shipping_mark[]"], select[name="filter_tier[]"]').on('change', function () {
            tAPI.ajax.reload();
        });
