            ...
            <div role="tabpanel"
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <?= render_input('shipping_mark', 'Shipping Mark', isset($client) ? $client->shipping_mark : ''); ?>
...
?>
                        <div class="row">
                            <div
                                class="col-md-<?= ! is_language_disabled() ? 6 : 12; ?> hide">
                                ...
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="default_language" id="default_language"
                                        ...
                                        foreach ($languages as $availableLanguage) {
                                            $selected = (isset($client) ? $client->default_language : 'english') == $availableLanguage ? 'selected' : '';
                                        ?>
                        ...
                        <?php $value = (isset($client) ? $client->service_fee : ''); ?>
                        <?= render_input('service_fee', 'service_fee', $value, ''); ?>

                        <?php $value = (isset($client) ? $client->tier : ''); ?>
                        <?= render_input('tier', 'tier', $value); ?>  
