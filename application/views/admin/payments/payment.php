                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <span class="tw-font-bold">
                                                    <?= e(app_format_money($payment->amount, '¥')); ?>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        && $payment->invoice->status != Invoices_model::STATUS_CANCELLED) { ?>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?= e(app_format_money($payment->invoice->total, '¥')); ?>
                                                    </td>
            ...
            && $payment->invoice->status != Invoices_model::STATUS_CANCELLED) { ?>
                                                    <td class="text-danger">
                                                        <?= e(app_format_money(get_invoice_total_left_to_pay($payment->invoice->id, $payment->invoice->total), '¥')); ?>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
