...
<div id="wrapper">
    <div class="content">
        <div class="container">
            <h4 class="bold page-title">LCL Contracts</h4>
            <?= form_open(
                isset($lcl) ? admin_url('contracts/edit_lcl/' . $lcl->id) : admin_url('contracts/save_lcl'),
                ['id' => 'lcl_contract_form']
            ); ?>
            <div class="panel_s">
                <div class="panel-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <?php
                            $fields = isset($lcl) ? json_decode($lcl->fields_value, true) : [];
                            ?>
                            <?= render_input('template_name', 'contract_title', isset($lcl) ? $lcl->name : ''); ?>
                            ...
                            <?= render_input('client_city', 'Client City', isset($fields['client_city']) ? $fields['client_city'] : ''); ?>
