...
$aColumns = [
    ...
    'amount',
    db_prefix() . 'invoicepaymentrecords.invoice_amount as invoice_amount',
...
$join = [
    ...
    'LEFT JOIN ' . db_prefix() . 'currencies ON ' . db_prefix() . 'currencies.id = ' . db_prefix() . 'invoices.invoice_currency',
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<span class="tw-font-medium">' . e(app_format_money($aRow['amount'], '¥')) . '</span>';
