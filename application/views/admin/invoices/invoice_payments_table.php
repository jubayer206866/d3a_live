...
<div class="table-responsive">
    <table class="table table-hover">
        <thead>
            <tr>
                <th>
                    <span class="bold"><?= _l('payments_table_number_heading'); ?></span>
                </th>
                <th>
                    <span class="bold"><?= _l('payments_table_mode_heading'); ?></span>
                </th>
                <th>
                    <span class="bold"><?= _l('payments_table_date_heading'); ?></span>
                </th>
                <th>
                    <span class="bold"><?= _l('payments_table_amount_heading'); ?></span>
                </th>
                <th>
                    <span class="bold"><?= _l('invoice_amount'); ?></span>
                </th>
                <th>
                    <span class="bold"><?= _l('options'); ?></span>
                </th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($invoice->payments as $payment) { ?>
                <tr class="payment">
                    ...
                    <td><?= e(app_format_money($payment['amount'], '¥')); ?>
                    </td>
