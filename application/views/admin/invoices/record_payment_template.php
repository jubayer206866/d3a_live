        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    $invoice_amount = $invoice->total_left_to_pay_invoice_amount;

echo render_input('invoice_amount', 'invoice_amount_lebel', $invoice_amount, 'number', ['max' => $invoice_amount]); ?>
                    <?php
                    
                    $amount = $invoice->total_left_to_pay;
$totalAllowed               = 0;
echo render_input('amount', 'record_payment_amount_received', $amount, 'number'); ?>
                    ...
                    <div class="form-group">
                        <label for="paymentmode"
                            ...
                            <label class="control-label"><?= _l('payment_mode'); ?></label>
