            ...
            <table class="table text-right">
                <tbody>
                    <tr id="subtotal">
                        <td>
                            <span
                                class="tw-font-medium tw-text-neutral-700"><?= _l('total'); ?></span>
                        </td>
                        <td class="subtotal">
                    ...
                    <tr>
                        <td>
                            <span
                                class="tw-font-medium tw-text-neutral-700"><?= _l('account_total'); ?></span>
                        </td>
                        <td class="total">
                            <?= e(app_format_money($invoice->total, '¥')); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= e('-' . app_format_money(sum_from_table(db_prefix() . 'invoicepaymentrecords', ['field' => 'amount', 'where' => ['invoiceid' => $invoice->id]]), '¥')); ?>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <span
                                class="tw-font-medium<?= $invoice->total_left_to_pay > 0 ? ' text-danger ' : ''; ?>">
                                <?= e(app_format_money($invoice->total_left_to_pay, '¥')); ?>
                            </span>
                        </td>
                    </tr>
                    <?php } ?>
