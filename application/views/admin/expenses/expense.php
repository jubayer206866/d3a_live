                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab_expense">
                            ...
                            <?php } ?>
                            <?php
                                $selected_category_type = isset($expense) ? $expense->category_type : '';
                                echo render_select(
                                    'category_type',
                                    [
...
<script>
    ...
    function customer_init() {
        ...
        $.get(admin_url + 'expenses/get_project_clients/' + project_id, function(response) {
    ...
    // On category_type change
    $('select[name="category_type"]').on('change', function() {
        populateExpenseCategory();
        toggleFieldsByCategoryType(); // keep your existing field hide/show logic
});       
