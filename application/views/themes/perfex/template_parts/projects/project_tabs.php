...
<div class="horizontal-scrollable-tabs preview-tabs-top panel-full-width-tabs">
    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs nav-tabs-horizontal no-margin" role="tablist">
            ...
            <li role="presentation" class="project_tab_packing_list">
                <a data-group="project_packing_list"
                    href="<?= site_url('clients/project/' . $project->id . '?group=project_packing_list'); ?>"
                    role="tab">
                    <i class="fa fa-inbox menu-icon menu-icon" aria-hidden="true"></i>
                    <?= _l('project_packing_list'); ?>
                </a>
            </li>

            <?php hooks()->do_action('after_customers_area_project_overview_tab', $project); ?>

            <!-- <?php if (($project->settings->view_tasks ?? 0) == 1 && ($project->settings->available_features['project_tasks'] ?? 0) == 1) { ?>
            ...
            <?php if (($project->settings->view_timesheets ?? 0) == 1 && ($project->settings->available_features['project_timesheets'] ?? 0) == 1) { ?>
            ...
            <?php if (($project->settings->view_milestones ?? 0) == 1 && ($project->settings->available_features['project_milestones'] ?? 0) == 1) { ?>
            ...
            <?php if (($project->settings->available_features['project_files'] ?? 0) == 1) { ?>
            ...
            <?php if (($project->settings->available_features['project_discussions'] ?? 0) == 1) { ?>
            ...
            <?php if (($project->settings->view_gantt ?? 0) == 1 && ($project->settings->available_features['project_gantt'] ?? 0) == 1) { ?>
            ...
            <?php if (has_contact_permission('support') && ($project->settings->available_features['project_tickets'] ?? 0) == 1) { ?>
            ...
            <!-- <?php if (has_contact_permission('proposals') && ($project->settings->available_features['project_proposals'] ?? 0) == 1) { ?>
            ...
            <!-- <?php if (has_contact_permission('estimates') && ($project->settings->available_features['project_estimates'] ?? 0) == 1) { ?>
            ...
            <?php if (has_contact_permission('invoices') && ($project->settings->available_features['project_invoices'] ?? 0) == 1) { ?>
            <li role="presentation" class="project_tab_invoices">
                <a data-group="project_invoices"
                    ...
                    role="tab">
                    <i class="fa fa-clipboard menu-icon menu-icon" aria-hidden="true"></i>
                    <?= _l('project_invoices'); ?></a>
            </li>
            <?php } ?>

             <li role="presentation" class="project_tab_Expances">
                <a data-group="project_expenses"
                href="<?= site_url('clients/project/' . $project->id . '?group=project_expenses'); ?>"
                role="tab">
                <i class="fa-regular fa-file-lines menu-icon menu-icon"></i>
                <?= _l('Expenses'); ?>
                </a>
            </li>

            <!-- <?php if (($project->settings->view_activity_log ?? 0) == 1 && ($project->settings->available_features['project_activity'] ?? 0) == 1) { ?>
            ...
            <li role="presentation" class="project_tab_purchase_order">
                <a data-group="purchase_order"
                    href="<?= site_url('clients/project/' . $project->id . '?group=purchase_order'); ?>"
                    role="tab">
            ...
            <li role="presentation" class="project_tab_inventory_receiving">
                <a data-group="inventory_receiving"
                    href="<?= site_url('clients/project/' . $project->id . '?group=inventory_receiving'); ?>"
                    role="tab">
                    <i class="fa fa-object-group menu-icon menu-icon"></i>
                    <?= _l('inventory_receiving_voucher'); ?>
                </a>
            </li>

            <?php if (has_contact_permission('contracts') && ($project->settings->available_features['project_contracts'] ?? 0) == 1) { ?>
            <li role="presentation" class="project_tab_contracts">
                <a data-group="project_contracts"
                    ...
                    role="tab">
                    <i class="fa-regular fa-note-sticky menu-icon menu-icon" aria-hidden="true"></i>
                    <?= _l('contracts'); ?></a>
            </li>
            <?php } ?>
        </ul>
