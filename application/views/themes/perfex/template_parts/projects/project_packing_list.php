    ...
    <tr>
        ...
        <td style="border: none !important;" colspan="5">
            <div style="padding-right:10px; text-align: left; font-size: 20px; font-weight:600">
                ...
                <br>
                VAT Nr: <?php echo hide_non_admin_info($client_info->vat); ?>
                <br>
                Phone Nr.: <?php echo hide_non_admin_info($client_info->phonenumber); ?>
                <br>
                Address: <?php echo hide_non_admin_info($client_info->address); ?>
