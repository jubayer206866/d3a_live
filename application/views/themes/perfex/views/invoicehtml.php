...
?>
                            ...
                            <tr>
                                ...
                                <td class="total">
                                    <?= e(app_format_money($invoice->invoice_amount, $invoice->currency_name)); ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= e('-' . app_format_money(sum_from_table(db_prefix() . 'invoicepaymentrecords', ['field' => 'invoice_amount', 'where' => ['invoiceid' => $invoice->id]]), $invoice->currency_name)); ?>
                                </td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                <td>
                                    <span
                                        class="<?= $invoice->total_left_to_pay_invoice_amount > 0 ? 'text-danger ' : ''; ?> bold">
                                        <?= _l('invoice_amount_due'); ?>
                                    </span>
                                </td>
                                <td>
                                    <span
                                        class="<?= $invoice->total_left_to_pay_invoice_amount > 0 ? 'text-danger' : ''; ?>">
                                        <?= e(app_format_money($invoice->total_left_to_pay_invoice_amount, $invoice->currency_name)); ?>
                                    </span>
                                </td>
                            </tr>
                            <?php } ?>
                ...
                <div class="col-md-12 text-center invoice-html-total-to-words">
                    <p class="tw-font-medium">
                        <?= _l('num_word'); ?>:<span
                            ...
                            <?= $this->numberword->convert($invoice->invoice_amount, $invoice->currency_name); ?>
                        </span>
                    </p>
                </div>
                <?php } ?>
                    ...
                    <table class="table table-hover invoice-payments-table tw-mt-2.5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= e(app_format_money($payment['invoice_amount'], $invoice->currency_name)); ?>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
